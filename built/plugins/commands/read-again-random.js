...
ReadAgainFollow = (_dec = (0, _plugin.Command)({ name: '设置随机复读概率', command: 'fd', type: 'group', info: "查看和设置随机复读概率, '!fd'查看当前概率, '!fd 0.x'设置概率", level: 2 }), _dec(_class = class ReadAgainFollow {
  getRedisKey(groupId) {
