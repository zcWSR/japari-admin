"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.Command = exports.Block = exports.Plugin = void 0;var _logger = _interopRequireDefault(require("../utils/logger"));
...
const Plugin = config => {
  ...
  if (typeof config === 'string') {
    config = _objectSpread(_objectSpread({}, defaultConfig), {}, { name: config });
...
const Command = config => {
  ...
  if (typeof config === 'string') {
    config = _objectSpread(_objectSpread({}, defaultConfig), {}, { name: config, command: config });
  } else if (typeof config === 'object') {
    config = _objectSpread(_objectSpread({}, defaultConfig), config);
  }
  ...
  return target => class extends target {
    ...
    trigger(params, body, type, commandMap) {var _this = this;return _asyncToGenerator(function* () {
        ...
        if (_this.level === 3) {
          if (!_qqService.default.isSuperAdmin(body.user_id)) {
