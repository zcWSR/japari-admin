...
const ARRAY_MESSAGE_FOLLOW_RATE = 0.5;let
...
SuchIsTheCase = (_dec = (0, _plugin.Plugin)({ name: 'such-is-the-case', wight: 96, type: 'group', shortInfo: '确实', info: '随机回复：确实', mute: true }), _dec(_class = class SuchIsTheCase {
  go(body) {var _this = this;return _asyncToGenerator(function* () {const
      ...
      {
        _logger.default.info(`group ${groupId} message '${message}', follow 'such-is-the-case'`);
        yield (0, _process.sleep)();
        _qqService.default.sendGroupMessage(groupId, '确实');
        return 'block';
      }
      return null;})();
  }
...
SuchIsTheCase;exports.default = _default;