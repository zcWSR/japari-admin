"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;const data = [
{
  name: '暴行',
  camp: '雷姆必拓',
  type: '近卫',
...

{
  ...
  sex: '女',
  characteristic:
  '不进行攻击，持续恢复攻击范围内所有友军的生命（每秒恢复相当于空攻击力10%的生命）',
  tags: ['支援', '远程位', '治疗', '资深干员'],
  hidden: true,
  'name-en': 'Sora' },
