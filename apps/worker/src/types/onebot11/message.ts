...
export const OB11MessageNodeSchema = Type.Object(
  {
    ...
    data: Type.Object({
      ...
      user_id: Type.Optional(
        Type.Union([Type.Number(), Type.String()], { description: '发送者QQ号' })
      ),
      uin: Type.Optional(
        Type.Union([Type.Number(), Type.String()], { description: '发送者QQ号(兼容go-cqhttp)' })
      ),
...
export const OB11MessageMixTypeSchema = Type.Union(
  [Type.Array(OB11MessageDataSchema), Type.String(), OB11MessageDataSchema],
...
export const OB11PostSendMsgSchema = Type.Object(
  {
    message_type: Type.Optional(
      Type.Union([Type.Literal('private'), Type.Literal('group')], { description: '消息类型' })
    ),
    ...
    auto_escape: Type.Optional(
      Type.Union([Type.Boolean(), Type.String()], { description: '是否作为纯文本发送' })
    ),
    source: Type.Optional(Type.String({ description: '消息来源' })),
    news: Type.Optional(
      Type.Array(
...
export const OB11MessageSchema = Type.Object(
  {
    ...
    message_type: Type.Union([Type.Literal('private'), Type.Literal('group')], {
      description: '消息类型'
    }),
    sub_type: Type.Optional(
      Type.Union([Type.Literal('friend'), Type.Literal('group'), Type.Literal('normal')], {
        description: '消息子类型'
      })
    ),
    sender: OB11SenderSchema,
    message: Type.Union([Type.Array(OB11MessageDataSchema), Type.String()], {
      description: '消息内容'
    }),
    message_format: Type.Union([Type.Literal('array'), Type.Literal('string')], {
      description: '消息格式'
    }),
    ...
    emoji_likes_list: Type.Optional(
      Type.Array(
        Type.Object({
          emoji_id: Type.String({ description: '表情ID' }),
...
// 返回数据接口定义
export interface OB11Return<T = unknown> {
  status: string;
  retcode: number;
  data: T;
  message: string;
